import random
import numpy as np
from geoschemagen.create_schema import (create_schema_typeA, create_schema_typeB, create_schema_typeC,
                                        create_schema_typeD, create_schema_typeE, create_schema_typeF,
                                        create_schema_typeS)
...
def generate_database(output_folder: str,
    ...
    Args:
        ...
        config_path (str): Path to the JSON configuration file for the model parameters.
        ...
        save_cptlike_image (bool): Whether to save the CPT-like images. Default is False.
