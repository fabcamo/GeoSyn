...
from geoschemagen.utils.soil_types import soil_behaviour_clay, soil_behaviour_siltmix, soil_behaviour_sandmix, soil_behaviour_sand, soil_behaviour_organic
